...
export default function RootLayout({
  ...
  const educationalOrganizationSchema = {
    ...
    "name": "Free IQ Test Online",
    "url": "https://www.example.com",
    "description": "Educational platform providing scientifically validated IQ tests and cognitive assessments for intelligence measurement and analysis.",
    "educationalCredentialAwarded": "IQ Assessment Certificate"
  };
