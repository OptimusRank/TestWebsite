...
export const metadata: Metadata = {
  ...
  description:
    "Take the RIOT IQ test free online and get your intelligence score instantly. Scientifically validated reasoning and intelligence assessment with detailed results.",
  keywords: [
    "IQ test",
    "intelligence test",
    "free IQ test",
