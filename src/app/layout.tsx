...
export const metadata: Metadata = {
  ...
  description:
    "Take the RIOT IQ Test free - measure your intelligence with our scientifically validated assessment. Get instant results with IQ score ranges, percentile rankings, and detailed cognitive analysis.",
  keywords: [
    "IQ test",
    "intelligence test",
    "free IQ test",
