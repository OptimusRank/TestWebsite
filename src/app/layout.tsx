...
export const metadata: Metadata = {
  ...
  description:
    "Take the free RIOT IQ Test (Reasoning Intelligence Online Test) - instant results, IQ score ranges, and cognitive breakdown. Compare with Elon Musk IQ, Trump IQ & average IQ.",
  keywords: [
    "IQ test",
    "intelligence test",
    "free IQ test",
