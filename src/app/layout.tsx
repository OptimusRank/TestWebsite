...
export const metadata: Metadata = {
  ...
  description:
    "Take the RIOT IQ test free online and discover your true intelligence. Get instant results, IQ score range analysis, and cognitive breakdown in 20 minutes.",
  keywords: [
    "IQ test",
    "intelligence test",
    "free IQ test",
