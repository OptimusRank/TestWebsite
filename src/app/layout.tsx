...
export default function RootLayout({
  ...
  const websiteSchema = {
    ...
    "@type": "WebSite",
    "name": "RIOT IQ Test",
    "description": "Revolutionary Intelligence Online Testing (RIOT) - Advanced IQ assessment platform providing rapid, intelligent, and optimized testing for comprehensive cognitive evaluation.",
    "url": "https://www.example.com",
    "potentialAction": {
      "@type": "SearchAction",
