...
export const metadata: Metadata = {
  ...
  description:
    "Take the RIOT IQ Test (Reasoning and Intelligence Online Test) free. Get instant IQ scores, detailed analysis, and compare with millions. Start your RiotIQ assessment now!",
  keywords: [
    "IQ test",
    "intelligence test",
    "free IQ test",
