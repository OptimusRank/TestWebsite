...
export const metadata: Metadata = {
  ...
  description:
    "Take the RIOT IQ test - the best free online IQ test trusted by millions. Get your intelligence score instantly with our reasoning and intelligence online test.",
  keywords: [
    "IQ test",
    "intelligence test",
    "free IQ test",
