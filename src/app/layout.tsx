...
export const metadata: Metadata = {
  ...
  description:
    "Take the official RIOT IQ test (Reasoning and Intelligence Online Test) free. Get your real IQ score instantly with our scientifically validated assessment.",
  keywords: [
    "IQ test",
    "intelligence test",
    "free IQ test",
