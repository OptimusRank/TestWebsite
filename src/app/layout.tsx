...
export const metadata: Metadata = {
  ...
  description:
    "Take the Riot IQ Test free online - the Reasoning and Intelligence Online Test (RIOT). Get your IQ score instantly with our validated assessment. Compare to average IQ ranges and celebrity IQs like Trump and Elon Musk.",
  keywords: [
    "IQ test",
    "intelligence test",
    "free IQ test",
