...
export const metadata: Metadata = {
  ...
  description:
    "Take the official RIOT IQ test free online. Reasoning and Intelligence Online Test with instant results, detailed score breakdown, and IQ ranges analysis.",
  keywords: [
    "IQ test",
    "intelligence test",
    "free IQ test",
