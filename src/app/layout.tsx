...
export const metadata: Metadata = {
  ...
  description:
    "Take the free RIOT IQ test online - Reasoning and Intelligence Online Test. Get your real IQ score instantly with our scientifically validated assessment.",
  keywords: [
    "IQ test",
    "intelligence test",
    "free IQ test",
