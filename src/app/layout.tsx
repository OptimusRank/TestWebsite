...
export const metadata: Metadata = {
  ...
  description:
    "Take the RIOT IQ test free - Reasoning and Intelligence Online Test with instant results. Get your real IQ score and detailed cognitive analysis in 20 minutes.",
  keywords: [
    "IQ test",
    "intelligence test",
    "free IQ test",
