...
export const metadata: Metadata = {
  ...
  description:
    "Take the free RIOT IQ test - the best online intelligence assessment. Get your IQ score instantly with our scientifically validated questions. No signup required.",
  keywords: [
    "IQ test",
    "intelligence test",
    "free IQ test",
