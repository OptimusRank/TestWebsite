    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Our <strong>scientifically validated</strong> assessment measures your cognitive
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Take Your Free Intelligence Test in Three Steps
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Our online IQ assessment is designed for quick completion with accurate results.
          </p>
        </div>
      ...
      >
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Trusted by millions for accurate cognitive assessment results.
          </p>
        </div>
            ...
            <Card key={index} className="border-border/50 bg-card/50">
              <CardContent className="pt-6">
                <div className="mb-4 flex items-center gap-3">
                  <div className="flex size-10 items-center justify-center rounded-full bg-indigo-500/10 font-semibold text-indigo-400">
      ...
      <section className="mx-auto max-w-4xl px-4 py-24 text-center sm:px-6">
        <div className="rounded-3xl bg-gradient-to-br from-indigo-950/50 to-violet-950/50 p-12 backdrop-blur-sm">
          <Trophy className="mx-auto mb-6 size-12 text-indigo-400" />
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Ready to Discover Your Intelligence Score?
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Join over 2.4 million people who have taken our free IQ test. Get your results in just 20 minutes.
          </p>
      ...
      <footer className="border-t border-border/50 bg-muted/30">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
          ...
          <div className="mt-8 border-t border-border/50 pt-8 text-center text-sm text-muted-foreground">
            <p>
              © 2024 IQ Test Online. All rights reserved. Our free intelligence test provides scientifically validated cognitive assessment results.
            </p>
          </div>
        </div>
      </footer>
