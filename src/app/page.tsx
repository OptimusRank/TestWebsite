    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-6xl lg:text-7xl">
            Take a Free IQ Test Online - Discover Your{" "}
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            ...
            awareness. Free to take with instant results and detailed breakdown.
          </p>
              ...
              <CardContent className="pt-6">
                ...
                <div className="mt-4">
                  ...
                  <div className="text-xs text-muted-foreground">
                    {testimonial.role} • IQ Score: {testimonial.score}
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="border-t border-border/50">
        <div className="mx-auto max-w-4xl px-4 py-24 text-center sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Join millions who've taken our free IQ test. Get your score, percentile ranking, and detailed cognitive breakdown in just 20 minutes.
          </p>
          <Link
            href="/test"
