...
const steps = [
  {
    ...
    description:
      "No signup required. Click start and begin your intelligence assessment immediately. The timer starts when you're ready.",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    description:
      "Instantly see your intelligence score, percentile ranking, and a breakdown of your cognitive strengths.",
  },
]
...
const testimonials = [
  ...
  },
  {
    name: "Priya R.",
    score: 142,
    text: "The pattern recognition section was challenging in a way that felt fair, not tricky. Best online IQ test I've taken.",
    role: "Data Scientist",
  },
]
...
const faqs = [
  {
    ...
    answer: "Our IQ test is calibrated against standardized assessments like WAIS and Stanford-Binet, with questions developed by cognitive psychologists. While no online test can replace a professional assessment, our results correlate strongly with standardized IQ tests."
  },
  {
    question: "How long does the IQ test take?",
    answer: "The complete IQ test takes about 20 minutes on average. You'll answer 40 questions of increasing difficulty across different cognitive areas including pattern recognition, logical reasoning, and spatial awareness."
  },
  {
    question: "Is this IQ test really free?",
    answer: "Yes, our IQ test is completely free. You get your score, percentile ranking, and detailed cognitive breakdown at no cost. No hidden fees, no credit card required, no subscription needed."
  },
  {
    question: "What IQ score is considered high?",
    answer: "An IQ score of 130 or above is typically considered high intelligence (top 2%). Average IQ is around 100, with 68% of people scoring between 85-115. Scores above 140 are considered very high intelligence."
  }
]
    ...
    <>
      ...
      <nav className="sticky top-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
          ...
          <Link href="/test" className={buttonVariants()}>
            Take IQ Test <ArrowRight className="ml-1 size-4" />
          </Link>
        </div>
      </nav>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take our scientifically validated IQ test and discover your cognitive abilities across pattern recognition, logical reasoning, and spatial
            awareness. Get your intelligence score instantly with detailed analysis.
          </p>
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Taking Your IQ Test: Three Simple Steps
          </h2>
        </div>
      ...
      >
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Real feedback from users who have taken our intelligence assessment.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-24 sm:px-6">
        <Card className="border-indigo-500/20 bg-gradient-to-r from-indigo-500/10 to-violet-500/10">
          <CardContent className="py-16 text-center">
            <Brain className="mx-auto mb-6 size-12 text-indigo-400" />
            <h2 className="mb-4 text-3xl font-bold">
              Ready to Discover Your Intelligence?
            </h2>
            <p className="mx-auto mb-8 max-w-xl text-muted-foreground">
              Join millions who have taken our free IQ test. Get your score, detailed analysis, and cognitive breakdown in just 20 minutes.
            </p>
            <Link
              href="/test"
      ...
      <footer className="border-t border-border/50 bg-muted/30">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Professional IQ testing with scientifically validated assessments and instant results.
              </p>
            </div>
            <div>
              <h4 className="mb-3 text-sm font-semibold">IQ Test</h4>
          ...
          <div className="text-center text-sm text-muted-foreground">
            <p>© 2024 RiotIQ. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
