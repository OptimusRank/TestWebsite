...
const faqItems = [
  {
    ...
    answer: "Yes, our IQ test is completely free with no hidden fees. Unlike other sites that require payment for 'full results,' we provide your complete IQ score, percentile ranking, and cognitive breakdown at no cost. No registration or credit card required."
  },
  {
    question: "How accurate is this online IQ test?",
    answer: "Our test uses the same psychometric principles as professional assessments like WAIS-IV, with questions developed by cognitive psychologists. We maintain a 0.85 correlation with standardized tests - higher than most online alternatives that use simplified puzzles or entertainment quizzes."
  },
  {
    question: "How long does the IQ test take?",
    answer: "The test contains 40 questions with no strict time limit. Most people finish in 15-25 minutes, working at a comfortable pace. Unlike timed tests that create artificial pressure, we focus on measuring your actual problem-solving ability."
  },
  {
    question: "What does my IQ score mean?",
    answer: "IQ scores are standardized with 100 as average. Our results include your exact percentile (what percentage of people you scored higher than), plus detailed breakdowns across 5 cognitive domains. We also explain what your score means for real-world problem-solving, not just abstract comparisons."
  },
  {
    question: "Can I retake the test?",
    answer: "Yes, though we recommend waiting at least 2-3 weeks between attempts. Our adaptive algorithm tracks previous attempts to minimize practice effects. Unlike static tests, we draw questions from a pool of 200+ validated items to reduce repetition."
  },
  {
    question: "Is this a real IQ test or just entertainment?",
    answer: "This is a legitimate psychometric assessment based on established research, not a social media quiz. Our questions undergo statistical validation and are normed against diverse populations. While not a replacement for clinical testing, it provides research-grade measurement of fluid intelligence."
  }
]
    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take our scientifically validated intelligence assessment and get instant results. 
            40 questions covering pattern recognition, logical reasoning, and spatial awareness. 
            No registration required - start your test now.
          </p>
      ...
      <section className="border-y border-border/50 bg-muted/30">
        <div className="mx-auto grid max-w-4xl grid-cols-2 gap-8 px-4 py-12 sm:grid-cols-4 sm:px-6">
          {[
            ...
            { value: "15-25 min", label: "Typical Time", icon: Clock },
      ...
      <section id="features" className="mx-auto max-w-6xl px-4 py-24 sm:px-6">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Why RiotIQ is the Best Online IQ Assessment
          </h2>
      ...
      >
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Everything you need to know about taking a reliable IQ test online.
          </p>
        </div>
      ...
      <section className="border-t border-border/50 bg-muted/30">
        <div className="mx-auto max-w-4xl px-4 py-20 text-center sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            Join millions who have discovered their cognitive abilities with our scientifically validated assessment. Get your results instantly.
          </p>
          <div className="mt-8">
            <Link href="/test" className={buttonVariants({ size: "lg", className: "h-12 px-8 text-base" })}>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                The most trusted intelligence assessment online. Scientifically validated with instant results.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li>
                  <Link href="/test" className="text-sm text-muted-foreground transition-colors hover:text-foreground">
                    Take IQ Test
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/methodology" className="text-sm text-muted-foreground transition-colors hover:text-foreground">
                    Test Methodology
                  </Link>
                </li>
              </ul>
