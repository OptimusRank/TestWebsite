...
export const metadata = { title: 'RIOT IQ Test - Free Online Intelligence Assessment', description: 'Take the RIOT IQ test free online. Reasoning and Intelligence Online Test with instant results and detailed cognitive breakdown.' }
