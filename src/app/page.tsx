...
export const metadata = {
  description: 'Take the RIOT IQ test - free online intelligence assessment with instant results. Scientifically validated questions, detailed cognitive breakdown.',
}
