...
const faqData = [
  {
    ...
    answer: "Our test is scientifically validated against established IQ scales like WAIS and Stanford-Binet. Results correlate strongly with professional assessments."
  },
  {
    question: "Is this IQ test really free?",
    answer: "Yes, our complete IQ test is 100% free. No hidden costs, subscriptions, or premium upgrades required to see your full results."
  },
  {
    question: "How long does the IQ test take?",
    answer: "Most people complete our 40-question IQ test in 15-25 minutes. You can take your time - there's no strict time limit."
  },
  {
    question: "What does my IQ score mean?",
    answer: "IQ scores compare your cognitive abilities to others. Average is 100, with 68% of people scoring 85-115. Scores above 130 indicate gifted intelligence."
  }
];
...
export default function Home() {
  ...
  const testSchema = {
    ...
    "@type": "WebApplication",
    "name": "Free IQ Test",
    "description": "Take our free online IQ test and get your score instantly. 40 scientifically validated questions measure your cognitive abilities.",
    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take our free IQ test and get instant results. Our scientifically validated assessment measures your cognitive
            abilities across pattern recognition, logical reasoning, and spatial
            awareness in just 20 minutes.
          </p>
      ...
      >
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            See what our test-takers say about their experience.
          </p>
        </div>
      ...
      >
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Everything you need to know about taking our free online IQ test.
          </p>
        </div>
      ...
      <section className="border-t border-border/50 bg-muted/30">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Join millions who have taken our free IQ test. Get your results in just 20 minutes.
          </p>
          <div className="mt-8">
            <Link href="/test" className={buttonVariants({ size: "lg", className: "h-12 px-8 text-base" })}>
