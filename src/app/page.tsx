...
export default function Home() {
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            ...
            awareness. Free to take, instant results, no registration required.
          </p>
      ...
      {/* What is an IQ Test section - moved up for better keyword prominence */}
        ...
        <div className="text-center">
          ...
          <div className="mx-auto mt-6 max-w-3xl text-left">
            <p className="text-muted-foreground mb-4">
              An IQ test (Intelligence Quotient test) is a standardized assessment designed to measure human intelligence and cognitive abilities. Our free online IQ test evaluates your mental capabilities across five key areas:
            </p>
            <ul className="space-y-2 text-muted-foreground">
              <li className="flex items-start gap-2">
                <CheckCircle className="mt-0.5 size-4 text-indigo-400 shrink-0" />
                <span><strong>Pattern Recognition:</strong> Your ability to identify relationships and sequences in visual information</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="mt-0.5 size-4 text-indigo-400 shrink-0" />
                <span><strong>Logical Reasoning:</strong> How well you analyze problems and draw logical conclusions</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="mt-0.5 size-4 text-indigo-400 shrink-0" />
                <span><strong>Spatial Awareness:</strong> Your capacity to visualize and manipulate objects in 3D space</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="mt-0.5 size-4 text-indigo-400 shrink-0" />
                <span><strong>Working Memory:</strong> Your ability to hold and process multiple pieces of information simultaneously</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="mt-0.5 size-4 text-indigo-400 shrink-0" />
                <span><strong>Processing Speed:</strong> How quickly you can complete cognitive tasks accurately</span>
              </li>
            </ul>
            <p className="text-muted-foreground mt-4">
              The average IQ score is 100, with 68% of the population scoring between 85 and 115. Our test provides instant results showing your IQ score, percentile ranking, and detailed breakdown of your cognitive strengths.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="mx-auto max-w-6xl px-4 py-24 sm:px-6">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Why Our IQ Test is the Most Accurate Online
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Built with psychometricians and validated against standardized IQ
            benchmarks including WAIS-IV and Stanford-Binet scales.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-4xl px-4 py-24 sm:px-6">
        ...
        <div className="space-y-8">
          <div>
            <h3 className="text-lg font-semibold mb-2">Is this a real IQ test?</h3>
            <p className="text-muted-foreground">
              Yes, our IQ test is scientifically validated and calibrated against standardized tests like WAIS-IV and Stanford-Binet. While not a replacement for professional assessment, it provides an accurate estimate of your cognitive abilities.
            </p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-2">How long does the IQ test take?</h3>
            <p className="text-muted-foreground">
              The test takes approximately 20 minutes to complete. You'll answer 40 progressively challenging questions across different cognitive domains. There's no time limit, so you can work at your own pace.
            </p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-2">What is a good IQ score?</h3>
            <p className="text-muted-foreground">
              The average IQ score is 100. Scores between 85-115 are considered average (68% of population), 115-130 are above average (14% of population), and scores above 130 are considered gifted (2% of population).
            </p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-2">Is the test free?</h3>
            <p className="text-muted-foreground">
              Yes, our IQ test is completely free to take. You'll get instant results including your IQ score, percentile ranking, and cognitive breakdown without any payment or subscription required.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-border/50">
        <div className="mx-auto max-w-4xl px-4 py-24 text-center sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Join over 2.4 million people who have taken our free IQ test. Get your score and detailed cognitive analysis in just 20 minutes.
          </p>
          <div className="mt-8">
            <Link href="/test" className={buttonVariants({ size: "lg", className: "h-12 px-8 text-base" })}>
        ...
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
          <div className="grid gap-8 md:grid-cols-4">
            <div className="md:col-span-2">
              ...
              <p className="mt-4 max-w-md text-sm text-muted-foreground">
                The most accurate free online IQ test. Scientifically validated,
                instant results, trusted by millions worldwide.
              </p>
            </div>
            <div>
          ...
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <p className="text-sm text-muted-foreground">
              © 2024 IQ Test. All rights reserved.
            </p>
            <p className="text-sm text-muted-foreground">
              Free, accurate, scientifically validated
            </p>
          </div>
        </div>
      </footer>
