...
const testimonials = [
  ...
  },
  {
    name: "Marcus J.",
    score: 125,
    text: "Took this free IQ test on my phone during lunch break. Clean interface, no spam, genuinely interesting questions.",
    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-6xl lg:text-7xl">
            Free IQ Test - Instant Results, No Registration
          </h1>

          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take our scientifically validated IQ test free online and discover your true intelligence in 20 minutes. Get instant results with detailed cognitive analysis across pattern recognition, logical reasoning, and spatial awareness.
          </p>
      ...
      <section className="mx-auto max-w-3xl px-4 py-24 sm:px-6">
        ...
        <div className="mt-16 space-y-8">
          <div>
            <h3 className="text-lg font-semibold mb-2">How accurate is this free IQ test?</h3>
            <p className="text-muted-foreground">
              Our IQ test is scientifically validated and calibrated against WAIS and Stanford-Binet scales. 
              Questions are developed by cognitive psychologists and normed against millions of test-takers worldwide.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              The test takes approximately 20 minutes to complete. It contains 40 questions that progressively 
              increase in difficulty across pattern recognition, logical reasoning, and spatial awareness.
            </p>
          </div>

          <div>
            <h3 className="text-lg font-semibold mb-2">Do I need to register or pay to take the test?</h3>
            <p className="text-muted-foreground">
              No registration or payment is required. The test is completely free and you can start immediately. 
              Your results are provided instantly upon completion.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Yes, this is a real IQ test based on established psychometric principles. While it's not a replacement 
              for professional assessment, it provides a scientifically sound estimate of your cognitive abilities.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-border/50 bg-muted/30">
        <div className="mx-auto max-w-3xl px-4 py-16 text-center sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Join over 2.4 million people who have taken our free IQ test. Get your results in 20 minutes.
          </p>
          <div className="mt-8">
            <Link
              href="/test"
            ...
            >
              Start Your Free IQ Test Now <ArrowRight className="ml-2 size-4" />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <p className="text-xs text-muted-foreground">
              © 2024 RIOT IQ Test. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
