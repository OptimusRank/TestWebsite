    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-6xl lg:text-7xl">
            Free IQ Test - Intelligence Assessment with{" "}
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take our scientifically validated IQ test in 20 minutes. Get your intelligence score, percentile ranking, and detailed cognitive breakdown instantly. No registration required.
          </p>
      ...
      <section className="border-y border-border/50 bg-muted/30">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold mb-4">What Is an IQ Test?</h2>
            <p className="max-w-3xl mx-auto text-muted-foreground">
              An IQ test measures your cognitive abilities through standardized questions. Our test evaluates pattern recognition, logical reasoning, spatial awareness, and verbal comprehension to calculate your Intelligence Quotient (IQ) score.
            </p>
          </div>
          
          <div className="grid max-w-4xl mx-auto grid-cols-2 gap-8 sm:grid-cols-4">
            {[
      ...
      <section id="features" className="mx-auto max-w-6xl px-4 py-24 sm:px-6">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Why Our IQ Test Is Different
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Built with psychometricians and validated against standardized IQ benchmarks like WAIS and Stanford-Binet.
          </p>
        </div>
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Take Your IQ Test in 3 Steps
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Our free IQ test takes about 20 minutes and provides instant, detailed results.
          </p>
        </div>
      ...
      {/* FAQ Section for IQ Test queries */}
      <section className="mx-auto max-w-4xl px-4 py-24 sm:px-6">
        ...
        <div className="space-y-8">
          <div className="border-l-4 border-indigo-500 pl-6">
            <h3 className="text-lg font-semibold mb-2">What is a good IQ test score?</h3>
            <p className="text-muted-foreground">
              The average IQ score is 100. Scores between 85-115 are considered average, 115-129 above average, and 130+ is considered gifted. Our test provides percentile rankings to show how you compare to the general population.
            </p>
          </div>

          <div className="border-l-4 border-indigo-500 pl-6">
            <h3 className="text-lg font-semibold mb-2">Is this IQ test accurate?</h3>
            <p className="text-muted-foreground">
              Our IQ test is based on established psychometric principles and correlated with standard tests like WAIS and Stanford-Binet. While no online test can replace professional assessment, our results provide a reliable estimate of your cognitive abilities.
            </p>
          </div>
          ...
          <div className="border-l-4 border-indigo-500 pl-6">
            ...
            <p className="text-muted-foreground">
              The test contains 40 questions and typically takes 15-25 minutes to complete. There's no strict time limit, but working efficiently helps ensure accurate results that reflect your natural problem-solving speed.
            </p>
          </div>

          <div className="border-l-4 border-indigo-500 pl-6">
            <h3 className="text-lg font-semibold mb-2">Can I retake the IQ test?</h3>
            <p className="text-muted-foreground">
              Yes, you can retake the test. However, familiarity with questions may slightly improve scores. For the most accurate assessment, we recommend waiting at least 6 months between attempts.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 py-24 text-center sm:px-6">
        <div className="rounded-3xl border border-border/50 bg-gradient-to-br from-indigo-500/5 via-background to-violet-500/5 p-12 sm:p-16">
          <Trophy className="mx-auto mb-6 size-12 text-indigo-400" />
          <h2 className="mb-4 text-3xl font-bold sm:text-4xl">
            Ready to Discover Your IQ?
          </h2>
          <p className="mx-auto mb-8 max-w-lg text-muted-foreground">
            Join millions who have taken our scientifically validated IQ test. Get your intelligence score and detailed cognitive breakdown in minutes.
          </p>
          <Link href="/test" className={buttonVariants({ size: "lg", className: "h-12 px-8 text-base" })}>
      ...
      <footer className="border-t border-border/50 bg-muted/30">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
          ...
          <div className="mt-8 border-t border-border/50 pt-8 text-center text-sm text-muted-foreground">
            © 2024 IQ Test Online. All rights reserved. | Free intelligence assessment with instant results.
          </div>
        </div>
      </footer>
    </>
