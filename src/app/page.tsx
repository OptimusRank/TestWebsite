    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take our scientifically validated IQ test and discover your true intelligence in just 20 minutes. 
            No registration required - get instant results with detailed cognitive breakdown.
          </p>
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Take the IQ Test in Three Simple Steps
          </h2>
        </div>
      ...
      >
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            See why millions trust our IQ test for accurate intelligence assessment.
          </p>
        </div>
      ...
      <section className="border-t border-border/50 bg-muted/30">
        <div className="mx-auto max-w-4xl px-4 py-24 text-center sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-lg text-muted-foreground">
            Join over 2.4 million people who have tested their intelligence with our scientifically validated IQ test.
          </p>
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link href="/test" className={buttonVariants({ size: "lg", className: "h-12 px-8" })}>
