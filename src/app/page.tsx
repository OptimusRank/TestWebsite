...
export const metadata: Metadata = {
  title: "IQ Test - Free Online Intelligence Test | Get Your Score Now",
  description: "Take a free IQ test online and discover your intelligence score in 20 minutes. Scientifically validated questions with instant results and detailed cognitive breakdown.",
  openGraph: {
    title: "IQ Test - Free Online Intelligence Test | Get Your Score Now",
    description: "Take a free IQ test online and discover your intelligence score in 20 minutes. Scientifically validated questions with instant results and detailed cognitive breakdown.",
    type: "website",
...
export default function Home() {
  const webPageSchema = {
    ...
    "description": "Take a free IQ test online and discover your intelligence score in 20 minutes. Scientifically validated questions with instant results.",
    "url": "https://www.riotiq.com/",
    "mainEntity": {
      "@type": "Quiz",
      "name": "IQ Test",
      "description": "Free online intelligence test with instant results",
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take a free IQ test with our scientifically validated assessment. Measure your cognitive
      ...
      <section className="mx-auto max-w-4xl px-4 py-24 text-center sm:px-6">
        <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
          Ready to Take Your IQ Test?
        </h2>
        <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
          Join millions who have discovered their intelligence score. Free, fast, and scientifically accurate.
        </p>
        ...
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Professional online IQ testing with scientifically validated results.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                Questions about your IQ test results? We're here to help.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <p className="text-sm text-muted-foreground">
              © 2025 IQ Test. All rights reserved.
            </p>
