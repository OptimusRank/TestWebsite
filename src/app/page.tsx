      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take the best IQ test online with RIOT (Reasoning and Intelligence Online Test). Our scientifically validated assessment measures your cognitive abilities across pattern recognition, logical reasoning, and spatial awareness. Get your real IQ score instantly - completely free with no signup required.
          </p>
