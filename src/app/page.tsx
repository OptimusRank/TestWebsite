    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            ...
            awareness with detailed analysis.
          </p>
      ...
      <section id="features" className="mx-auto max-w-6xl px-4 py-24 sm:px-6">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            ...
            benchmarks for accurate intelligence testing.
          </p>
        </div>
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Take Your Intelligence Test in Three Simple Steps
          </h2>
        </div>
      ...
      >
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Hear from people who've discovered their cognitive strengths through
      ...
      {/* CTA */}
      <section className="bg-gradient-to-r from-indigo-500/10 to-violet-500/10 py-16">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            ...
            Free to take, instant results, scientifically validated.
          </p>
          <div className="mt-8">
            <Link href="/test" className={buttonVariants({ size: "lg", className: "h-12 px-8 text-base" })}>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Professional online intelligence testing with instant results and detailed cognitive analysis.
              </p>
            </div>

            <div>
              <h4 className="mb-4 text-sm font-semibold">Test Features</h4>
          ...
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="flex items-center gap-1 text-sm text-muted-foreground">
              ...
              <span>Scientifically Validated Assessment</span>
            </div>
          </div>
        </div>
      </footer>
