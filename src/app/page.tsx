    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take our scientifically validated IQ test and get instant results. Our free online intelligence assessment measures cognitive abilities across pattern recognition, logical reasoning, and spatial awareness.
          </p>
      ...
      >
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Real feedback from our 2.4M+ test-takers worldwide.
          </p>
        </div>
            ...
            <Card key={testimonial.name} className="border-border/50 bg-card/50">
              <CardContent className="pt-6">
                <div className="mb-4 flex items-center gap-3">
                  <div className="flex size-12 items-center justify-center rounded-full bg-indigo-500/10 text-sm font-bold text-indigo-400">
      ...
      <section id="faq" className="mx-auto max-w-4xl px-4 py-24 sm:px-6">
        ...
        <div className="mt-16 space-y-8">
          <div>
            <h3 className="text-lg font-semibold mb-2">How accurate is this IQ test?</h3>
            <p className="text-muted-foreground">
              Our IQ test is scientifically validated and calibrated against WAIS and Stanford-Binet scales. Questions are developed by cognitive psychologists and normed against millions of test-takers worldwide.
            </p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-2">Is the IQ test really free?</h3>
            <p className="text-muted-foreground">
              Yes, our IQ test is completely free. You get instant results including your IQ score, percentile ranking, and cognitive breakdown without any payment required.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              The IQ test consists of 40 questions and takes approximately 20 minutes to complete on average. There is no strict time limit.
            </p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-2">What makes this the best IQ test online?</h3>
            <p className="text-muted-foreground">
              Our test combines scientific validity with user experience. Unlike other free IQ tests, we provide detailed cognitive breakdowns, use modern question formats, and don't require signup or payment.
            </p>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-2">Can I take this IQ test on my phone?</h3>
            <p className="text-muted-foreground">
              Yes! Our IQ test is fully responsive and works on all devices - desktop, tablet, and mobile. The interface is optimized for touch interactions.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-border/50 bg-muted/30">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Join 2.4 million people who have taken our free IQ test. Get instant results and see how you compare.
          </p>
          <div className="mt-8">
            <Link href="/test" className={buttonVariants({ size: "lg", className: "h-12 px-8 text-base" })}>
      ...
      <footer className="border-t border-border/50">
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Professional IQ testing with instant results and scientific validation.
              </p>
            </div>
            <div>
              <h4 className="font-semibold">IQ Tests</h4>
              <div className="mt-2 space-y-1 text-sm">
                <Link href="/test" className="block text-muted-foreground hover:text-foreground">
                  Free IQ Test
                </Link>
                <Link href="/assessments/full" className="block text-muted-foreground hover:text-foreground">
                  Full Assessment
                </Link>
              </div>
            </div>
            <div>
              ...
              <div className="mt-2 space-y-1 text-sm">
                ...
                <Link href="/forum" className="block text-muted-foreground hover:text-foreground">
                  Community Forum
                </Link>
              </div>
            </div>
          ...
          <div className="mt-8 border-t border-border/50 pt-8 text-center text-sm text-muted-foreground">
            <p>&copy; 2024 IQTest. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
