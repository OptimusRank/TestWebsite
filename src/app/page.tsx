...
const faqs = [
  {
    ...
    answer: "Our test is scientifically validated against standard IQ benchmarks like WAIS and Stanford-Binet, with questions developed by cognitive psychologists. While no online test can replace professional assessment, our results correlate strongly with standardized tests."
  },
  {
    question: "How long does the IQ test take?",
    answer: "The average completion time is 20 minutes for all 40 questions. There's no strict time limit, but we recommend taking it in one sitting for the most accurate results."
  },
  {
    question: "Is this IQ test really free?",
    answer: "Yes, completely free with no hidden charges. You get your full IQ score, percentile ranking, and cognitive breakdown without paying anything or providing personal information."
  },
  {
    question: "What IQ score is considered high?",
    answer: "IQ scores follow a normal distribution with 100 as average. Scores above 130 (top 2%) are considered high, while 115-129 is above average. Our test provides detailed percentile rankings to show exactly where you stand."
  }
];
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take our free IQ test online and get instant results. Our scientifically validated assessment measures your cognitive
            abilities across pattern recognition, logical reasoning, and spatial
            awareness. No signup required - start your intelligence test now.
          </p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-24 text-center sm:px-6">
        <div className="rounded-3xl border border-border/50 bg-gradient-to-br from-indigo-500/10 to-violet-500/10 px-8 py-16 sm:px-16">
          <Trophy className="mx-auto mb-6 size-12 text-indigo-400" />
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Ready to Discover Your IQ?
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Join millions who have taken our free IQ test. Get your intelligence score and cognitive breakdown in just 20 minutes.
          </p>
          <Link
            href="/test"
            className={buttonVariants({ 
              size: "lg", 
              className: "mt-8 h-12 px-8 text-base bg-indigo-600 hover:bg-indigo-700" 
            })}
          >
      ...
      <footer className="border-t border-border/50 bg-muted/30 py-12">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-8 border-t border-border/50 pt-8 text-center text-sm text-muted-foreground">
            © 2024 IQTest. All rights reserved. Professional online intelligence testing.
          </div>
        </div>
      </footer>
    </>
