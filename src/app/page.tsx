...
const testimonials = [
  ...
  },
  {
    name: "Priya R.",
    score: 142,
    text: "The pattern recognition section was challenging in a way that felt fair, not tricky. Best free IQ test I've tried.",
    role: "Data Scientist",
  },
]
  ...
  return (
    <>
        ...
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold tracking-tight">
              RiotIQ<span className="text-indigo-400">.com</span>
            </span>
          </Link>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take our scientifically validated IQ test and discover your 
            cognitive abilities across pattern recognition, logical reasoning, and spatial
            awareness. Free online IQ test with instant results - no signup required.
          </p>
          ...
          <div className="mt-8 text-sm text-muted-foreground">
            ✓ No registration required  ✓ Instant IQ score  ✓ 40 validated questions  ✓ Works on mobile
          </div>
        </div>
      </section>
          ...
          {testimonials.map((testimonial) => (
            <Card key={testimonial.name} className="border-border/50 bg-card/50">
              <CardContent className="pt-6">
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <div className="flex">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <Star key={i} className="size-3 fill-indigo-400 text-indigo-400" />
                    ))}
                  </div>
                </div>
                ...
                <cite className="mt-4 block text-sm font-medium">
      ...
      <section className="mx-auto max-w-3xl px-4 py-24 text-center sm:px-6">
        ...
        <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
          Join millions who have taken our free IQ test. Get your score and detailed 
          cognitive analysis in just 20 minutes.
        </p>
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link href="/test" className={buttonVariants({ size: "lg", className: "h-12 px-8 text-base" })}>
            Take Free IQ Test
