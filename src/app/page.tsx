...
const faqs = [
  {
    ...
    answer: "Our IQ test takes approximately 20 minutes to complete and consists of 40 carefully designed questions. You can take breaks if needed, but the timer will continue running."
  },
  {
    question: "Is the IQ test really free?",
    answer: "Yes, our IQ test is completely free. No signup required, no hidden fees, and you get instant results with a detailed breakdown of your cognitive abilities."
  },
  {
    question: "How accurate is the online IQ test?",
    answer: "Our test is scientifically validated and calibrated against WAIS and Stanford-Binet scales. Questions are developed by cognitive psychologists and tested against millions of users worldwide."
  },
  {
    question: "What is a good IQ score?",
    answer: "The average IQ score is 100. Scores between 85-115 are considered normal (68% of population). Scores above 130 are considered gifted, while scores above 145 are considered highly gifted."
  },
  {
    question: "Can I retake the IQ test?",
    answer: "Yes, you can retake the test, though we recommend waiting at least 24 hours between attempts for the most accurate results. Practice effects may slightly inflate scores on immediate retests."
  }
]
    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take our scientifically validated IQ test and discover your cognitive abilities. 
            40 questions, 20 minutes, instant results with detailed breakdown. 
            Start your intelligence assessment now - completely free.
          </p>
      ...
      >
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Real feedback from people who have taken our IQ test.
          </p>
        </div>
      ...
      <section className="border-t border-border/50 bg-muted/30">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6">
          ...
          <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
            Join 2.4 million people who have already taken our scientifically validated 
            IQ test. Get your results in just 20 minutes.
          </p>
