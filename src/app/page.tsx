...
const faqItems = [
  {
    ...
    answer: "Our IQ test is scientifically validated and calibrated against WAIS and Stanford-Binet scales. Questions are developed by cognitive psychologists and normed against millions of test-takers worldwide."
  },
  {
    question: "Is this IQ test really free?", 
    answer: "Yes, our IQ test is completely free. No registration required, no hidden fees, and you get instant results with a detailed cognitive breakdown."
  },
  {
    question: "How long does the IQ test take?",
    answer: "The test contains 40 questions and takes approximately 20 minutes to complete. You can pause and resume at any time."
  },
  {
    question: "What does my IQ score mean?",
    answer: "IQ scores are standardized with 100 as average. 68% of people score between 85-115. Scores above 130 are considered gifted, while scores above 145 are highly gifted."
  }
]
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Take our scientifically validated IQ test with instant results. This free online intelligence assessment measures your cognitive abilities across pattern recognition, logical reasoning, and spatial awareness.
          </p>
      ...
      <footer className="border-t border-border/50 bg-muted/30 py-12">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <p className="text-sm text-muted-foreground">
              © 2026 IQTest. The most accurate free IQ test online.
            </p>
          </div>
        </div>
      </footer>
