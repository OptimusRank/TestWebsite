      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-4 pb-20 pt-24 text-center sm:px-6 sm:pt-32">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            The RIOT (Reasoning and Intelligence Online Test) is our scientifically validated free IQ test that measures your cognitive abilities across pattern recognition, logical reasoning, and spatial awareness. Take the riot iq test free with instant results.
          </p>
